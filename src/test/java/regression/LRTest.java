...
public class LRTest {
    ...
    public void regression() throws Exception {
        ...
        //store predictions
        db.execute("MATCH () - [r:WORKS_FOR] -> () WHERE exists(r.time) AND NOT exists(r.progress) SET " +
        ...
        //check that the model returns same predictions as the model stored in the procedure
        ...
        db.execute("MATCH (:Node)-[r:WORKS_FOR]->(:Node) WHERE exists(r.time) AND NOT exists(r.progress) " +
